...
def test_convert_netcdf_zip_response_preserves_member_filenames_as_metadata(
    ...
    assert [dataset.attrs["fews_zip_member_filename"] for dataset in datasets] == [
        "always_applied__modifiable_simulatedforecasting_5minutes.nc",
        "always_applied__workflowresult_simulatedforecasting_5minutes.nc",
        "apply_as_created__modifiable_simulatedforecasting_5minutes.nc",
        "apply_as_created__workflowresult_simulatedforecasting_5minutes.nc",
        "base_simulatedforecasting_5minutes.nc",
        "double_simulatedforecasting_5minutes.nc",
        "double_simulatedforecasting_nonequidistant.nc",
        "double__11.11_simulatedforecasting_5minutes.nc",
        "double__5_simulatedforecasting_5minutes.nc",
        "integer_13_simulatedforecasting_5minutes.nc",
        "integer_simulatedforecasting_nonequidistant.nc",
        "integer__13_simulatedforecasting_5minutes.nc",
        "integer__5_simulatedforecasting_5minutes.nc",
        "never_applied_in_whatif__modifiable_simulatedforecasting_5minutes.nc",
        "never_applied_in_whatif__workflowresult_simulatedforecasting_5minutes.nc",
        "number_simulatedforecasting_5minutes.nc",
        "only_applied_in_whatif__modifiable_simulatedforecasting_5minutes.nc",
        "only_applied_in_whatif__workflowresult_simulatedforecasting_5minutes.nc",
        "series_A_simulatedforecasting_5minutes.nc",
        "series_B_simulatedforecasting_5minutes.nc",
        "series_C_simulatedforecasting_5minutes.nc",
        "ts_byenumeration_simulatedforecasting_5minutes.nc",
    ]
